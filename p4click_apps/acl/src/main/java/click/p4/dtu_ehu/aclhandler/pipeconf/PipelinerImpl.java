...
package click.p4.dtu_ehu.aclhandler.pipeconf;
...
import click.p4.dtu_ehu.aclhandler.common.Utils;
...
import static click.p4.dtu_ehu.aclhandler.AppConstants.CPU_CLONE_SESSION_ID;
...
public class PipelinerImpl extends AbstractHandlerBehaviour implements Pipeliner {
    ...
    private static final String ACL_TABLE = "IngressImpl.aclhandler_ing.acl_table";
    private static final String CLONE_TO_CPU = "IngressImpl.aclhandler_ing.clone_to_cpu";
