...
public class AppConstants {
    ...
    public static final String APP_NAME = "click.p4.dtu_ehu.l2forwarding";
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("click.p4.dtu_ehu.l2forwarding");
